...
# Deploys AWS EC2 instances from images listed in datasources.tf, runs an AWS User Data script to apply security measures and install Apache, and uploads public keys to enable access to each instance.
